...
public class CodeGenerator {
	...
	private static final boolean saveGeneratedFiles = AccessController.doPrivileged(new GetBooleanAction("sun.misc.CodeGenerator.saveGeneratedFiles"));
		...
		try {
			...
			for (List<ProxyMethod> value : proxyMethods.values()) {
				for (ProxyMethod proxyMethod : value) {
					this.fields.add(new CodeGenerator.FieldInfo(proxyMethod.methodFieldName, "Ljava/lang/reflect/Method;", 10));
	...
	private CodeGenerator.MethodInfo generateConstructor() throws IOException {
		CodeGenerator.MethodInfo methodInfo = new CodeGenerator.MethodInfo("<init>", "(Ljava/lang/reflect/InvocationHandler;)V", 1);
		...
		outputStream.writeShort(this.cp.getMethodRef("java/lang/reflect/Proxy", "<init>", "(Ljava/lang/reflect/InvocationHandler;)V"));
	...
	private CodeGenerator.MethodInfo generateStaticInitializer() throws IOException {
		...
		var1.exceptionTable.add(new CodeGenerator.ExceptionTableEntry(var4, var5, var3, this.cp.getClass("java/lang/NoSuchMethodException")));
		...
		var1.exceptionTable.add(new CodeGenerator.ExceptionTableEntry(var4, var5, var3, this.cp.getClass("java/lang/ClassNotFoundException")));
		this.code_astore(var2, outputStream);
		outputStream.writeByte(187);
		...
		outputStream.writeShort(this.cp.getMethodRef("java/lang/Throwable", "getMessage", "()Ljava/lang/String;"));
		outputStream.writeByte(183);
		outputStream.writeShort(this.cp.getMethodRef("java/lang/NoClassDefFoundError", "<init>", "(Ljava/lang/String;)V"));
		outputStream.writeByte(191);
	...
	private class ProxyMethod {
		...
		private CodeGenerator.MethodInfo generateMethod() throws IOException {
			...
			outputStream.writeShort(CodeGenerator.this.cp.getFieldRef("java/lang/reflect/Proxy", "h", "Ljava/lang/reflect/InvocationHandler;"));
			CodeGenerator.this.code_aload(0, outputStream);
			outputStream.writeByte(178);
			outputStream.writeShort(CodeGenerator.this.cp.getFieldRef(CodeGenerator.dotToSlash(CodeGenerator.this.className), this.methodFieldName, "Ljava/lang/reflect/Method;"));
			...
			outputStream.writeShort(CodeGenerator.this.cp.getInterfaceMethodRef("java/lang/reflect/InvocationHandler", "invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;"));
			...
			if (exceptionTypes.size() > 0) {
				for (Class<?> exceptionType : exceptionTypes) {
					methodInfo.exceptionTable.add(new ExceptionTableEntry(var7, var8, var6, CodeGenerator.this.cp.getClass(CodeGenerator.dotToSlash(exceptionType.getName()))));
				}
				outputStream.writeByte(191);
				var6 = (short) methodInfo.code.size();
				methodInfo.exceptionTable.add(new CodeGenerator.ExceptionTableEntry(var7, var8, var6, CodeGenerator.this.cp.getClass("java/lang/Throwable")));
				CodeGenerator.this.code_astore(var4, outputStream);
				outputStream.writeByte(187);
				outputStream.writeShort(CodeGenerator.this.cp.getClass("java/lang/reflect/UndeclaredThrowableException"));
				outputStream.writeByte(89);
				CodeGenerator.this.code_aload(var4, outputStream);
				outputStream.writeByte(183);
				outputStream.writeShort(CodeGenerator.this.cp.getMethodRef("java/lang/reflect/UndeclaredThrowableException", "<init>", "(Ljava/lang/Throwable;)V"));
				outputStream.writeByte(191);
			}
			...
			if (methodInfo.code.size() > 65535) {
				...
				for (int var14 = 0; var14 < this.exceptionTypes.length; ++var14) {
					methodInfo.declaredExceptions[var14] = CodeGenerator.this.cp.getClass(CodeGenerator.dotToSlash(this.exceptionTypes[var14].getName()));
				}
				return methodInfo;
			}
		}
		...
		private void codeWrapArgument(Class<?> var1, int var2, DataOutputStream outputStream) throws IOException {
			if (var1.isPrimitive()) {
				...
				outputStream.writeShort(CodeGenerator.this.cp.getMethodRef(var4.wrapperClassName, "valueOf", var4.wrapperValueOfDesc));
			} else {
		...
		private void codeUnwrapReturnValue(Class<?> aClass, DataOutputStream outputStream) throws IOException {
			if (aClass.isPrimitive()) {
				...
				outputStream.writeByte(182);
				outputStream.writeShort(CodeGenerator.this.cp.getMethodRef(var3.wrapperClassName, var3.unwrapMethodName, var3.unwrapMethodDesc));
				if (aClass != Integer.TYPE && aClass != Boolean.TYPE && aClass != Byte.TYPE && aClass != Character.TYPE && aClass != Short.TYPE) {
					if (aClass == Long.TYPE) {
		...
		private void codeFieldInitialization(DataOutputStream outputStream) throws IOException {
			...
			for (int var2 = 0; var2 < this.parameterTypes.length; ++var2) {
				...
				if (this.parameterTypes[var2].isPrimitive()) {
					CodeGenerator.PrimitiveTypeInfo var3 = CodeGenerator.PrimitiveTypeInfo.get(this.parameterTypes[var2]);
					outputStream.writeByte(178);
					outputStream.writeShort(CodeGenerator.this.cp.getFieldRef(var3.wrapperClassName, "TYPE", "Ljava/lang/Class;"));
				} else {
			...
			outputStream.writeByte(182);
			outputStream.writeShort(CodeGenerator.this.cp.getMethodRef("java/lang/Class", "getMethod", "(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;"));
